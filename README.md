...
Copy the latest videos from your YouTube subscriptions feed to a playlist.
...
1. Install requirements
        ...
        ```
2. Get your YouTube cookies into a cookies.txt file. See [the yt-dlp wiki page](https://github.com/yt-dlp/yt-dlp/wiki/FAQ#how-do-i-pass-cookies-to-yt-dlp) on how to.
